...
import {Hero, Services, PopularProducts, Subscibe, Footer, SpecialOffer, SuperQuality, CustomerReviews } from "./sections"
...
const App = () => (
  <main className="relative ">
    ...
    <section className="padding-x sm:py-32 py-16 w-full"><Subscibe/></section>
