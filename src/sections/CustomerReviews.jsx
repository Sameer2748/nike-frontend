...
const CustomerReviews = () => {
  return (
    <section className="max-container">
      ...
      <p className="info-text m-auto mt-4 max-w-lg text-center">Hear genuine stories from our satistfied customers about their exceptional experiences with us. </p>
